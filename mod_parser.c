...
SWITCH_STANDARD_APP(get_json_value_function)
{
}

SWITCH_STANDARD_APP(get_xml_value_function)
{
}
...
SWITCH_MODULE_LOAD_FUNCTION(mod_parser_load)
{
	...
	*module_interface = switch_loadable_module_create_module_interface(pool, modname);
	...
	SWITCH_ADD_APP(app_interface, "get_json_value", "Get value from JSON object, encoded to string", "Get value from JSON object, encoded to string", get_json_value_function, "<JSON> <path_to_value>", SAF_NONE);
	SWITCH_ADD_APP(app_interface, "get_xml_value", "Get value from XML document, encoded to string", "Get value from XML document, encoded to string", get_xml_value_function, "<XML> <path_to_value>", SAF_NONE);
//	SWITCH_ADD_APP(app_interface, "get_config_value", "Get value from XML config", "Get value from XML config", get_config_value_function, "<section> <path_to_value>", SAF_NONE);
